...
// --- Cursos ---
export type CoursesRes = InferResponseType<typeof api.academic.courses.$get>;
export type CourseByIdRes = InferResponseType<(typeof api.academic.courses)[typeof UUID_PATH]["$get"]>;
export type CreateCourseReq = InferRequestType<typeof api.academic.courses.$post>["json"];
export type UpdateCourseReq = InferRequestType<(typeof api.academic.courses)[typeof UUID_PATH]["$put"]>["json"];
export type DeleteCourseRes = InferResponseType<(typeof api.academic.courses)[typeof UUID_PATH]["$delete"]>;
...
export type DeleteEditionRes = InferResponseType<typeof api.academic.courses.editions[typeof UUID_PATH]["$delete"]>;
...
export const getCourses = async (): Promise<CoursesRes> => {
  const res = await api.academic.courses.$get();
...
export const getCourseById = async (id: string): Promise<CourseByIdRes> => {
  ...
  const res = await (api.academic.courses as any)[UUID_PATH].$get({ param: { id } });
  return await res.json();
};

export const createCourse = async (data: CreateCourseReq) => {
  const res = await api.academic.courses.$post({ json: data });
  return await res.json();
};

export const updateCourse = async (id: string, data: UpdateCourseReq) => {
  const res = await (api.academic.courses as any)[UUID_PATH].$put({
    param: { id },
    json: data
  });
  return await res.json();
...
export const deleteCourse = async (id: string): Promise<DeleteCourseRes> => {
  const res = await (api.academic.courses as any)[UUID_PATH].$delete({ param: { id } });
  return await res.json();
};
...
export const getCourseEditions = async (): Promise<EditionsRes> => {
  const res = await api.academic.courses.editions.$get();
  return await res.json();
};

export const createCourseEdition = async (data: CreateEditionReq) => {
  const res = await api.academic.courses.editions.$post({ json: data });
  return await res.json();
};
...
export const getCourseEditionById = async (id: string): Promise<EditionByIdRes> => {
  ...
  const res = await api.academic.courses.editions[":id"].$get({ param: { id } });
  return await res.json();
};
...
export const updateCourseEdition = async (id: string, data: UpdateEditionReq) => {
  ...
  const res = await api.academic.courses.editions[":id"].$put({
    param: { id },
    json: data
  });
  return await res.json();
...
export const deleteCourseEdition = async (id: string): Promise<DeleteEditionRes> => {
  const res = await api.academic.courses.editions[":id"].$delete({ 
    param: { id } 
  });
  return await res.json();
};
...
import { formatLeadDate } from "./leadDetail.formatters";
...
interface CommonProps { members: LeadCampaignViewModel[]; selectedMemberId: string; campaignId: string; creatorUserId: string; onChange: (memberId: string) => void }
...
export function LeadInteractionsTab({ members, selectedMemberId, campaignId, creatorUserId, onChange, canCreate }: CommonProps & { canCreate: boolean }) {
  const [dialogOpen, setDialogOpen] = useState(false);
  const controller = useLeadInteractions(campaignId, selectedMemberId, creatorUserId);
...
export function LeadTasksTab({ members, selectedMemberId, campaignId, creatorUserId, onChange, canManage }: CommonProps & { canManage: boolean }) {
  ...
  const controller = useLeadTasks(campaignId, selectedMemberId, creatorUserId);

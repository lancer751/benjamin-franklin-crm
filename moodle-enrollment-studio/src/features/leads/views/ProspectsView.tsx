...
const ProspectsView = () => {
  ...
  // Rango de fechas avanzado (Estilo Google Analytics / Dashboards Premium)
  ...
  const filteredLeads = useMemo(() => {
    ...
    return leads.filter((lead: any) => {
      ...
      // 📅 Filtro de Rango de Fechas por Timestamps
      let matchDate = true;
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          // Mostrar un texto amigable si viene el crudo del backend
  ...
  // Helper to format date string to DD/MM/YYYY for presentation
  ...
  // Helper to get descriptive label for trigger button
  ...
  return (
    <div className="space-y-6 fade-in">
      ...
      {/* 🌟 FILTROS REESTRUCTURADOS PARA ASESORES DE VENTA (Estilo Antigravity) */}
      <div className="flex flex-col md:flex-row items-end gap-3 rounded-xl bg-white p-4 border border-slate-100 shadow-sm">
        
        {/* 📅 NUEVO: Filtro por fecha de creación del lead (Popover) */}
        ...
        {/* Conditional Clear Button (Minimalist Floating Icon with X) */}
        {hasActiveFilters && (
          <button 
            type="button"

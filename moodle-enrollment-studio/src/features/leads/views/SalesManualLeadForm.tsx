...
export function SalesManualLeadForm() {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">
              {isEdit ? "Editar Prospecto (Comercial)" : "Registro Manual de Prospecto"}
            </h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              {isEdit 
                ? "Modifica los datos de comunicación del lead para continuar el seguimiento." 
                : "Registra un prospecto, asígnalo a una campaña y registra la interacción inicial."}
            </p>
          </div>
        </div>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          className="rounded-xl focus-visible:ring-[#005088]" 
                          disabled={isEdit}
                          {...field} 
                        />
                      </FormControl>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          maxLength={8} 
                          className="rounded-xl font-mono focus-visible:ring-[#005088]" 
                          disabled={isEdit}
                          {...field} 
                        />
                      </FormControl>
          ...
          <div className="space-y-6">
            ...
            {/* Solo se muestran Card 3 y Card 4 en modo CREACIÓN */}
            {!isEdit && (
              <>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value || undefined}>
                            ...
                            <SelectContent className="rounded-xl">
                              <SelectItem value="none" disabled>Selecciona una campaña</SelectItem>

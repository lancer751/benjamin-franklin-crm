...
export const EditionScheduleSlotSchema = z
  .object({
    id: UUIDField,
...
export const CreateEditionScheduleSlotSchema = EditionScheduleSlotSchema.omit({
  id: true,
  schedule_id: true,
});
...
export const EditionScheduleSchema = z
  .object({
    id: UUIDField,
...
export const CreateEditionScheduleSchema = EditionScheduleSchema.omit({
  id: true,
  edition_id: true,
  created_at: true,
  updated_at: true,
